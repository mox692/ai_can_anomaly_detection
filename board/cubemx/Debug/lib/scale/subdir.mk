...
C_SRCS += \
/Users/motoyuki.kimura/work/ai_can_anomaly_detection/board/lib/scale/scale.c 
...
lib/scale/scale.o: /Users/motoyuki.kimura/work/ai_can_anomaly_detection/board/lib/scale/scale.c lib/scale/subdir.mk
...
clean: clean-lib-2f-scale

clean-lib-2f-scale:
	-$(RM) ./lib/scale/scale.cyclo ./lib/scale/scale.d ./lib/scale/scale.o ./lib/scale/scale.su

.PHONY: clean-lib-2f-scale
